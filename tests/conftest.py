...
sys.modules.setdefault("browser_tools_session", browser_tools_session)
sys.modules.setdefault("camoufox_session", camoufox_session)
sys.modules.setdefault("cdp_client", cdp_client)
sys.modules.setdefault("interstitial", interstitial)
sys.modules.setdefault("mcp_daemon", mcp_daemon)
sys.modules.setdefault("persistent_browser", persistent_browser)
